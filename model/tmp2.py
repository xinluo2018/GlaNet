...
class u2net_att_2(nn.Module):
    def __init__(self, num_bands_b1, num_bands_b2):
        ...
        self.up_conv1 = conv3x3_bn_relu(192, 64)  # in: 196
        self.up_conv2 = conv3x3_bn_relu(128, 64)   # in: 64+64
        self.up_conv3 = conv3x3_bn_relu(128, 64)   # in: 64+64
    ...
    def forward(self, x):       ## input size: 7x256x256
        ...
        ## decoder part
        # level 4
        x4_fuse_att = self.cross_att_4(x4_att_b1, x4_att_b2)  # 128

        # level 3 
        x3_att_b1 = self.att_3_b1(x3_b1)
        x3_att_b2 = self.att_3_b2(x3_b2)         
        x3_fuse_att = self.cross_att_3(x3_att_b1, x3_att_b2)  # 64
        x3_up = torch.cat([self.up(x4_fuse_att), x3_fuse_att], dim=1)  # 128+64
        ...
        x1_up = torch.cat([self.up(x2_up), x1_b1, x1_b2], dim=1)   # 64+32+32
        x1_up = self.up_conv3(x1_up)  ##  64
