...
author: xin luo
create: 2026.1.5
des: a simple U-Net model with channel-spatial attention
'''
...
class unet_att(nn.Module):
    def __init__(self, num_bands):
        ...
        self.att_2 = CBAMBlock(channel=48+16, reduction=4, kernel_size=7)
        self.att_3 = CBAMBlock(channel=64+32, reduction=4, kernel_size=7)
        self.att_4 = CBAMBlock(channel=128+64, reduction=4, kernel_size=7)
