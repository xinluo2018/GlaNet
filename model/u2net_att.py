...
class u2net_att(nn.Module):
    def __init__(self, num_bands_b1, num_bands_b2):
        ...
        self.up_conv4 = conv3x3_bn_relu(256, 128)   # 
        self.up_conv3 = conv3x3_bn_relu(256, 128)   # in:
    ...
    def forward(self, x):       ## input size: 7x256x256
        ...
        x3_att_fuse = torch.cat([self.up(x4_fuse_att), x3_fuse_att], dim=1)  # 128+128
        ...
        x2_att_fuse = torch.cat([self.up(x3_att_fuse), x2_fuse_att], dim=1)   # 128+64
...
if __name__ == '__main__':
    model = u2net_att(num_bands_b1=6, num_bands_b2=1)
